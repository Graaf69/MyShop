...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id="1", Email="tgreef@wamsys.co.za", ZipCode="90210"});
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("greef@wamsys.co.za", "Forms"), null);
